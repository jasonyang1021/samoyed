...
export default function ArticleLanguagePanel({ changeId, sourceTitle, sourceContent, sourceSummary, sourceFacts, sourceType, date, author, source, url, labImpact }: { changeId: string; sourceTitle: string; sourceContent: string; sourceSummary: string; sourceFacts: string[]; sourceType: string; date: string; author: string; source: string; url?: string | null; labImpact: boolean }) {
